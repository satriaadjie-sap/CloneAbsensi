...
import InformationPenting from '../InformationPentingKry';
import RowPertanyaan from '../RowPertanyaanKry';



const FormPengisian_4_1Kry = () => {
...
export default FormPengisian_4_1Kry
